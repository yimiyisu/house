export default {
  ...
  condition: ["title","structure"],
  slots: {
    action$({ row }) {
      return (
        <>
          <z-action p='gaz1fw56' label='明细' data={row} mode='drawer' href='/daily/houseDetail' fixed='detail' link map={{"houseId":"id"}} includeTitle='l' />
        </>
      )
    }
  }
