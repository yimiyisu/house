export default {
  ...
  entitys: [{"name":"id","label":"编号","type":"search"},{"name":"uid","label":"创建人","type":"user"},{"name":"createGmt","label":"创建时间","type":"date"},{"name":"updateGmt","label":"更新时间","type":"date"},{"name":"type","label":"工单类型","code":"workorderType"},{"name":"status","label":"工单状态","code":"workorderStatus"},{"name":"priority","label":"是否加急","type":"switch"},{"name":"describe","label":"工单描述","type":"textarea"},{"name":"communityId","label":"小区id","type":"search","depend":"community"},{"name":"images","label":"图片","type":"image"},{"name":"phone","label":"联系人电话"},{"name":"voice","label":"语音"},{"name":"recipientId","label":"受理人","type":"search","depend":"community_manager"},{"name":"file","label":"附件","type":"inputTag"},{"name":"licensePlate","label":"车牌号"},{"name":"houseId","label":"房屋","type":"search","depend":"house"}],
  columns: ["type","priority","phone","createGmt","status"],
  condition: ["type"],
  slots: {
      header$() {
      return (
...
<z-action p='9g5thq5g91h' label='编辑' mode='dialog' fields={["type","describe","images","priority","phone"]} link data={row} url='/do/patch/workorder' />
